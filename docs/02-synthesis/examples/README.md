...
| [retiming_walkthrough/](./retiming_walkthrough/) |
| [mapping_walkthrough/](./mapping_walkthrough/) | 与 [04 工艺映射](../04-technology-mapping.md) §11 | 与 [06 §8 Retiming](../06-timing-driven-optimization.md#8-retiming寄存器搬移--流水线重平衡) | 与 [03 章 粗粒度优化](../03-optimization.md) §11 对照 |
