...
| [tdo_walkthrough/](./tdo_walkthrough/) | 与 [06 章 §2–§5 细粒度引擎](../06-timing-driven-optimization.md) 内部 delay/slack 案例 |
| [mapping_walkthrough/](./mapping_walkthrough/) | 与 [04 工艺映射](../04-technology-mapping.md) §11、与 [03 章](../03-optimization.md) §11 对照 |
