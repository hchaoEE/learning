...
| 3 | [03-optimization](./03-optimization.md) | **已写** | 组合 → **AIG** → 优化 |
| 4 | [04-technology-mapping](./04-technology-mapping.md) | **已写** | AIG/网表 → 单元 |
| 5 | [05-constraints-sdc](./05-constraints-sdc.md) | **已写** | SDC 约束语言 |
| 6 | [06-timing-driven-optimization](./06-timing-driven-optimization.md) | **已写** | 映射后修时序 |
| 7 | [07-synthesis-reports](./07-synthesis-reports.md) | **已写** | 读报告 |
| 8 | [08-low-power-synthesis](./08-low-power-synthesis.md) | **已写** | UPF/ICG |
