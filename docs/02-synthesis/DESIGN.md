...
| 章 | 主题 | 与主链关系 |
|----|------|------------|
| 09 LEC | RTL↔网表等价 | **签核**，非 transform pass |
| 10 层次 | 分块、预算、abstract | **流程**包装 01–06 |
| 11 DFT | Scan 插入 | **compile 后** 再优化/LEC |
| 12 交付 | 文件包、corner、门控 | **输出** 定义 |

**编号**：09–12 在 **功能综合主链（01–08）之后** 阅读；09、12 对 **所有角色** 建议必读。
...
| 寄存器级优化（常量/等价/无负载） | 已写 | 02 §10、09 §3.2 |
| Multibit FF banking / debank | 已写 | 06 §2.7 |
| Boundary optimization | 已写 | 10 §6.1 |
| ECO / 增量综合 | 已写 | 12 §8 |
