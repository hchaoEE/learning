...
| 术语 | 一句话 | 详见 |
|------|--------|------|
| **Design DB** | 综合器内存中的网表+属性+约束图 | [01 §2](./01-rtl-parsing-and-elaboration.md) |
| **GTECH** | 工艺无关门（`GTECH_AND`、`SEQGEN`） | [01 §9](./01-rtl-parsing-and-elaboration.md) |
| **Elaborate** | 展开 generate/参数，RTL→GTECH | [01 §7](./01-rtl-parsing-and-elaboration.md) |
